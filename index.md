...
address: "Undervisningslokale 1 in the University Library on the South Campus, Njalsgade 80, 2300 Copenhagen S"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "September 11 & 15, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Søren Willer Hansen", "Lars Kjær", "Lorna Wildgaard", "Asger Væring Larsen", "Henrik Hornemann", "Ene Rammer Nielsen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
<p id="xxx">
  <strong>Register here:</strong> <a href="https://enterlinktoKUBcalenderhere" target="_blanck">Copenhagen University Library</a>
</p>
...
<p id="who-can-attend">
    ...
    This workshop is open to students and other new beginners interested in an introduction to best practices, tips and tricks to working with data in sheets. The workshop is open for all students at the University of Copenhagen.
</p>
